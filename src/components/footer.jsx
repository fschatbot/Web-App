...
import { FaReact, FaAutoprefixer } from "react-icons/fa";
import { SiTailwindcss, SiPostcss } from "react-icons/si";
		...
		return (
			<footer>
				<div>
					...
					<div>
						<h1>Sub Packages Used</h1>
						<ul>
							<li>Dynamics.js</li>
							<li>
								AutoPrefixer
								<FaAutoprefixer className="text-[#dd3735]" />
							</li>
							<li>
								PostCSS
								<SiPostcss className="text-[#d6380a]" />
							</li>
							<li>
								VS Code
								<svg viewBox="0 0 128 128">
									...
									<path d="M59.184 63.531l36.953-28.285-.239-28.297S94.32.773 89.055 3.99L39.879 48.851zm0 0" fill="#0877b9" />
									<path
